...
import info.jeczmien.dal.ApplicationEntityDAOImpl;
import info.jeczmien.rest.ApplicationResource;
import info.jeczmien.rest.impl.ApplicationResourceImpl;
import info.jeczmien.services.impl.ApplicationServiceImpl;
import info.jeczmien.services.impl.PersistentServiceImpl;
import info.jeczmien.services.impl.SearchServiceImpl;
import info.jeczmien.services.impl.StateServiceImpl;
...
public class AppModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(ApplicationService.class, ApplicationServiceImpl.class);
		binder.bind(PersistentService.class, PersistentServiceImpl.class);
		binder.bind(ApplicationEntityDAO.class, ApplicationEntityDAOImpl.class);
		binder.bind(ApplicationResource.class, ApplicationResourceImpl.class);
	}
